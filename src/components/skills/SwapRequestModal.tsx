      ...
      {step === "success" ? (
        <div className="p-8 text-center">
          ...
          <p className="text-slate-400 mb-6">
            Your request has been sent to <strong className="text-white">{match.user.name}</strong>. 
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="bg-surface-3 rounded-xl p-4 border border-white/6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-center">
                <ArrowLeftRight size={20} className="text-indigo-400 mx-auto" />
                <span className="text-xs text-indigo-300 font-bold">{match.matchPercentage}% match</span>
              </div>
          ...
          {/* Schedule */}
          <div>
            <p className="text-sm font-medium text-slate-300 mb-3">Preferred days</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="h-10 rounded-xl bg-white/5 border border-white/10 text-slate-100 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
              />
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-slate-400">Session duration</label>
              <select
                value={form.duration}
