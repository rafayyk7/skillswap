      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        <div className="relative rounded-3xl overflow-hidden p-16 sm:p-24">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/15 border border-indigo-500/25 text-indigo-600 dark:text-indigo-300 text-sm font-medium mb-8">
              <Sparkles size={14} />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/explore"
                className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl bg-white/8 dark:bg-white/8 border border-black/12 dark:border-white/12 text-slate-700 dark:text-white font-semibold text-lg hover:bg-black/5 dark:hover:bg-white/12 hover:border-black/15 dark:hover:border-white/20 transition-all"
              >
                Browse Skills First
              </Link>
            </div>
