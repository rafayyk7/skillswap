    ...
    <section className="py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          <span className="text-cyan-500 dark:text-cyan-400 text-sm font-semibold tracking-wider uppercase mb-4 block">
            Skill Matches
          </span>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          {featured.map((match) => {
            ...
            return (
              <div
                key={match.userId}
                className="bg-surface-2 border border-black/6 dark:border-white/6 rounded-2xl p-6 hover:border-black/10 dark:hover:border-white/15 transition-all duration-300 hover:-translate-y-1 group"
              >
                ...
                <div className="flex items-center justify-between text-sm mb-5">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-slate-900 dark:text-white font-medium">{user.rating}</span>
                ...
                <Link
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-indigo-500/30 text-indigo-600 dark:text-indigo-400 text-sm font-medium hover:bg-indigo-500/10 hover:border-indigo-400 transition-all"
                >
                  View Profile
                  <ArrowRight size={14} />
                </Link>
